...
#define DMA_DEFAULT_INCREMENT_MODIFIER 0            // STEP SIZE 
...
#define DMA_REQUIRED_TRANSFER_ACTION 2              // BLOCK ACTION 
...
#define DMA_DEFAULT_PRIORITY_LEVEL 3         // PRIORITY LEVEL - CHPRILVL
